...
@export var setting_dictionary: Dictionary = {
	...
	choose.keys()[choose.textbox_opacity]: Setting_Range.new(choose.textbox_opacity, 50, 0.0, 100, 1.0),
	choose.keys()[choose.master_volume]: Setting_Range.new(choose.master_volume, 50, 0.0, 100, 1.0),
	choose.keys()[choose.system_volume]: Setting_Range.new(choose.system_volume, 50, 0.0, 100, 1.0),
	choose.keys()[choose.music_volume]: Setting_Range.new(choose.music_volume, 50, 0.0, 100, 1.0),
	choose.keys()[choose.ambiant_volume]: Setting_Range.new(choose.ambiant_volume, 50, 0.0, 100, 1.0),
	choose.keys()[choose.sfx_volume]: Setting_Range.new(choose.sfx_volume, 50, 0.0, 100, 1.0),
	choose.keys()[choose.voice_volume]: Setting_Range.new(choose.voice_volume, 50, 0.0, 100, 1.0),
